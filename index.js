...
//Exibir a data do último acesso ao usuário (cookies)
...
// durante o uso do sistema, a aplicação saberá, dentro da uma sessão válida, com quem ela se comunica.
app.use(session({
...
app.post('/login', (requisicao, resposta)=>{
    ...
    if(usuario && senha && (usuario === 'victor') && (senha === '123')){
